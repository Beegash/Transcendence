      ...
      <div class="w-full max-w-md">
        <div class="card">
          ...
          <div class="my-6 flex items-center">
            ...
            <span class="px-4 text-white/60 text-sm">${t('auth.orContinueWith')}</span>
            <div class="flex-1 border-t border-pong-light"></div>
          </div>
          ...
          <div class="space-y-3">
            <a href="/api/auth/oauth/google" class="flex items-center justify-center gap-3 w-full py-3 border border-pong-light rounded-lg hover:bg-pong-light/50 transition-colors">
              ...
              <span class="text-white">${t('auth.loginWithGoogle')}</span>
            </a>
            ...
            <a href="/api/auth/oauth/github" class="flex items-center justify-center gap-3 w-full py-3 border border-pong-light rounded-lg hover:bg-pong-light/50 transition-colors">
              ...
              <span class="text-white">${t('auth.loginWithGithub')}</span>
            </a>
            ...
            <a href="/api/auth/oauth/42" class="flex items-center justify-center gap-3 w-full py-3 border border-pong-light rounded-lg hover:bg-pong-light/50 transition-colors">
              ...
              <span class="text-white">${t('auth.loginWith42')}</span>
            </a>
          </div>
